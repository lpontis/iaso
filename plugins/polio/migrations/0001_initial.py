            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, help_text="When the campaign starts", null=True
                    ),
                ),
                (
                    "three_level_call_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="3 level call"),
                ),
                (
                    "cvdpv_notified_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="cVDPV Notication"),
                ),
                (
                    "cvdpv2_notified_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="cVDPV2 Notication"),
                ),
                (
                    "pv_notified_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="PV Notication"),
                ),
                (
                    "pv2_notified_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="PV2 Notication"),
                ),
                (
                    "virus",
                    models.CharField(
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="1st Draft Submission"
                    ),
                ),
                (
                ...
                (
                    "investigation_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="Field Investigation Date"
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateTimeField(blank=True, null=True, verbose_name="AG/nOPV Group"),
                ),
                (
                    "dg_authorized_at",
                    models.DateTimeField(blank=True, null=True, verbose_name="DG Authorization"),
                ),
                (
                    "budget_status",
                    models.CharField(
